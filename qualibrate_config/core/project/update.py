from qualibrate_config.core.project.create import (fill_project_storage_location,
                                                   fill_project_calibration_library_folder,
                                                   fill_project_quam_state_path,
                                                   fill_project_database, after_create_project,
...
def update_project(
    ...
    fill_project_calibration_library_folder(existing_config, calibration_library_folder)
